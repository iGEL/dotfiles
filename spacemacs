...
you should place your code here."
  ...
  (defun clojure-yas-mode-hook ()
    (clj-refactor-mode 1)
    (yas-minor-mode 1))
  (defun eval-buffer-and-run-all-tests ()
    (interactive)
    (save-buffer)
    (cider-load-buffer)
